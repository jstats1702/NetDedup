...
double logcond_Xi (const uword &Xi_i, const uword &caso, const uword &curlab, const uword &newlab, const rowvec &u_new, const uword &i, const double &I, const double &K, uvec Xi, const double &sigsq, const double &beta, mat Ustar, const uvec &Y)
{
...
void sample_Xi (const double &I, const double &K, uvec &Xi, const double &sigsq, const double &beta, mat &Ustar, const uvec &Y)
{
     ...
     for (i = 0; i < I; ++i) {
          ...
          if (prolab == curlab)
               ...
               accp = exp( logcond_Xi(prolab, caso, curlab, newlab, u_new, i, I, K, Xi, sigsq, beta, Ustar, Y) - logcond_Xi(curlab, caso, curlab, newlab, u_new, i, I, K, Xi, sigsq, beta, Ustar, Y) );
          // set new label
...
//[[Rcpp::export]]
void MCMC (uvec Xi, const double &K, const uvec &Y, const uword &nburn, const uword &nsams, const uword &nskip, const uword &ndisp, string path)
{
     ...
     for (s = 1; s <= S; ++s) {
          // update
          sample_Xi    (I, K, Xi, sigsq, beta, Ustar, Y);
