...
ptm <- proc.time()
matching0_R(Xi, model, prior, case, dataset, method = "PM")
proc.time() - ptm

ptm <- proc.time()
matching0_R(Xi, model, prior, case, dataset, method = "LG")
proc.time() - ptm

ptm <- proc.time()
matching0_R(Xi, model, prior, case, dataset, method = "MPMMS")
proc.time() - ptm