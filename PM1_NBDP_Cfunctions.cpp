...
double logcond_Xi (const uword &Xi_i, const uword &caso, const uword &curlab, const uword &newlab, const rowvec &pi_new, const uword &i, const double &I, const double &L, const uvec &Mell, const double &a, const double &q, const vec &Mu, const vec &Vartheta, umat W, uvec Xi, mat Pi, const mat &Pe)
{
...
void sample_Xi (const double &I, const double &L, const uvec &Mell, const double &a, const double &q, const vec &Mu, const vec &Psi, const vec &Vartheta, umat &W, uvec &Xi, mat &Pi, const mat &Pe)
{
     ...
     for (i = 0; i < I; ++i) {
          ...
          if (prolab == curlab)
               ...
               accp = exp( logcond_Xi(prolab, caso, curlab, newlab, pi_new, i, I, L, Mell, a, q, Mu, Vartheta, W, Xi, Pi, Pe) - logcond_Xi(curlab, caso, curlab, newlab, pi_new, i, I, L, Mell, a, q, Mu, Vartheta, W, Xi, Pi, Pe) );
          // set new label
...
//[[Rcpp::export]]
void MCMC (const double &a_psi, const double &b_psi, uvec Xi, const double &a, const double &q, const double &al, const vec &Mu0, const uvec &Mell, const mat &Pe, const uword &nburn, const uword &nsams, const uword &nskip, const uword& ndisp, string path)
{
     ...
     for (s = 1; s <= S; ++s) {
          // update
          sample_Xi       (I, L, Mell, a, q, Mu, Psi, Vartheta, W, Xi, Pi, Pe);
