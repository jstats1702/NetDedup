...
void sample_Xi (const double &I, const double &L, const double &K, const uvec &Mell, const double &theta, const vec &Psi, const vec &Vartheta, umat &W, uvec &Xi, mat &Pi, const mat &Pe, const double &sigsq, const double &beta, mat &Ustar, const uvec &Y)
{
     ...
     for (i = 0; i < I; ++i) {
          ...
          if (prolab == curlab)
               ...
               accp = exp( logcond_Xi(prolab, caso, curlab, newlab, pi_new, u_new, i, I, L, K, Mell, theta, Vartheta, W, Xi, Pi, Pe, sigsq, beta, Ustar, Y) - logcond_Xi(curlab, caso, curlab, newlab, pi_new, u_new, i, I, L, K, Mell, theta, Vartheta, W, Xi, Pi, Pe, sigsq, beta, Ustar, Y) );
          // set new label
...
//[[Rcpp::export]]
void MCMC (const double &a_psi, const double &b_psi, uvec Xi, const double &a_t, const double &b_t, const uvec &Mell, const mat &Pe, const double &K, const uvec &Y, const uword &nburn, const uword &nsams, const uword &nskip, const uword &ndisp, string path)
{
     ...
     for (s = 1; s <= S; ++s) {
          // update
          sample_Xi        (I, L, K, Mell, theta, Psi, Vartheta, W, Xi, Pi, Pe, sigsq, beta, Ustar, Y);
